...
CHECKLIST_SECTIONS = {
    "🌊 Волновой анализ": {
        "5 волн по канону (3 не самая короткая, чередование коррекций)": (9, "Основа сетапа", "⚠️ Кроме 5 волн в коррекциях меньшего ТФ"),
        "Равенство глубины коррекции": (4, "Коррекции сопоставимы по глубине", "⚠️ Если коррекция слишком мала/большая — сигнал слабый"),
        "Удлинение по Фибоначчи 161-227": (6, "Подтверждение окончания тренда", "⚠️ Сильные выбросы цены могут исказить проекцию"),
        "Удлинение по Фибоначчи 227-261": (6, "Подтверждение окончания тренда", "⚠️ Сильные выбросы цены могут исказить проекцию"),
        "Пробой наклонки 2-4 волна на минутке": (4, "Подтверждение смены тренда", "⚠️ Ложные пробои при низкой ликвидности"),
    },
    "🎛 Индикаторы": {
        "Индикатор Student на 1 минутке": (4, "Подтверждение 3 волны", "⚠️ Слабый тренд — сигнал может быть ложным"),
        "Дивергенция RSI на 7 минутах": (3, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "Дивергенция CCI на 7 минутах": (3, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "Дивергенция на 1ч ТФ": (2, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "Дивергенция на 4ч ТФ": (3, "Усиленный сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "Дивергенция на 1д ТФ": (4, "Важный показатель направления тренда", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "CCI в зоне ~200 или -200": (1, "Индикатор перекупленности/перепроданности", "⚠️ Не торгуем на слишком резких импульсах"),
        "RSI в зоне ~20 или ~80": (3, "Подтверждает экстремальное состояние рынка", "⚠️ Ложные сигналы при низкой ликвидности или сильном движении"),
    },
    "💧 Ликвидность и объёмы": {
        "Фандинг противоположный": (6, "Фундаментальный фактор", "⚠️ Учитывать направление фандинга"),
        "Движение в зоны ликвидности (50x / 100x)": (4, "Цена стремится к стопам и ликвидациям", "⚠️ Не входить если объемы и ликвидность слишком аномальные"),
        "Объемы на 7 минутах": (4, "Подтверждает силу движения", "⚠️ Объем может быть ложным при новостных выбросах"),
        "Объемы выше среднего": (3, "Подтверждает силу движения", "⚠️ Объем может быть ложным при новостных выбросах"),
    },
    "🚀 Тренд и контекст": {
        "Торгуем по тренду": (6, "Следование за глобальным трендом снижает риск", "⚠️ Тренд не подтвержден старшими ТФ"),
        "Есть ли подход к линиям дневного тренда на 1Ч или 4Ч": (4, "Ключевой сигнал смены направления", "⚠️ Ложные пробои при боковике"),
        "Пробитие линии тренда": (4, "Ключевой сигнал смены направления", "⚠️ Ложные пробои при боковике"),
        "Соответствие старшему ТФ": (4, "Сигнал на младшем ТФ должен подтверждаться старшим", "⚠️ Если старший ТФ против — сигнал слабый"),
        "Анализ BTC и BTC.D для альты": (2, "Зависимость альткоинов от биткоина", "⚠️ Не входить если BTC движется аномально"),
        "Шаблон похожего паттерна": (2, "История повторяется — полезно, но не всегда", "⚠️ Могут быть ложные паттерны"),
    },
    "🛡️ Риск и фильтры": {
        ...
        "РММ соблюден 1:1 МИНИМУМ": (3, "Соотношение риск/прибыль не менее 1:1", "⚠️ Минимальное требование для безопасной торговли"),
    }
}
