...
CHECKLIST_SECTIONS = {
    "🌊 Волновой анализ": {
        "5 волн (3 не самая короткая, чередование коррекций)": (20, "Основа сетапа", "⚠️ Кроме 5 волн в коррекциях меньшего ТФ"),
        "Удлинение по Фибоначчи 161-227": (8, "Подтверждение окончания тренда", "⚠️ Сильные выбросы цены могут исказить проекцию"),
        "Удлинение по Фибоначчи 227-261": (8, "Подтверждение окончания тренда", "⚠️ Сильные выбросы цены могут исказить проекцию"),
        "5 волн + наклонка в 5й + ретест фибы 50% (флаг)": (9, "Идеальный сетап", "⚠️ Ложные пробои при низкой ликвидности"),
    },
    "🎛 Индикаторы": {
        "Сигнал от Student на 1 минутке": (4, "Подтверждение 3 волны", "⚠️ Слабый тренд — сигнал может быть ложным"),
        "Дивергенция RSI": (4, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "Дивергенция CCI": (4, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
    },
    "💧 Ликвидность и объёмы": {
        "Фандинг противоположный": (6, "Фундаментальный фактор", "⚠️ Учитывать направление фандинга"),
        "Объемы на текущем ТФ": (7, "Подтверждает силу движения", "⚠️ Объем может быть ложным при новостных выбросах"),
    },
    "🚀 Тренд и контекст": {
        "Торгуем по тренду": (10, "Следование за глобальным трендом", "⚠️ Тренд не подтвержден старшими ТФ"),
        "Торгуем по тренду BTC": (10, "Альты следуют за биткоином", "⚠️ Не входить если BTC движется аномально"),
    },
    "🛡️ Риск и фильтры": {
        "НЕ КИНЖАЛ": (2, "Цена НЕ должна двигаться резкими тенями без структуры", "⚠️ Ложные сигналы при всплесках ликвидности"),
        "Более 1,5% TakeProfit": (4, "Цель сделки — адекватное RR", "⚠️ Не входить если RR слишком мал или слишком большой"),
