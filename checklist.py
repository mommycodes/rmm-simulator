...
CHECKLIST_SECTIONS = {
    "🌊 Волновой анализ": {
        "5 волн по канону (3 не самая короткая, чередование коррекций)": (15, "Основа сетапа", "⚠️ Кроме 5 волн в коррекциях меньшего ТФ"),
        ...
        "Пробой наклонки 2-4 волна на минутке": (5, "Подтверждение смены тренда", "⚠️ Ложные пробои при низкой ликвидности"),
    },
    "🎛 Индикаторы": {
        "Индикатор Student на 1 минутке": (6, "Подтверждение 3 волны", "⚠️ Слабый тренд — сигнал может быть ложным"),
        "Дивергенция RSI на 7 минутах": (4, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
        "Дивергенция CCI на 7 минутах": (4, "Ранний сигнал", "⚠️ ПРИ СИЛЬНОМ ИМПУЛЬСЕ/ПРОЛИВЕ ДИВЕР НЕ РАБОТАЕТ"),
    ...
    "💧 Ликвидность и объёмы": {
        "Фандинг противоположный": (8, "Фундаментальный фактор", "⚠️ Учитывать направление фандинга"),
        ...
        "Объемы на 7 минутах": (6, "Подтверждает силу движения", "⚠️ Объем может быть ложным при новостных выбросах"),
        "Объемы выше среднего": (4, "Подтверждает силу движения", "⚠️ Объем может быть ложным при новостных выбросах"),
    },
    "🚀 Тренд и контекст": {
        "Торгуем по тренду": (8, "Следование за глобальным трендом снижает риск", "⚠️ Тренд не подтвержден старшими ТФ"),
        "Есть ли подход к линиям дневного тренда на 1Ч или 4Ч": (6, "Ключевой сигнал смены направления", "⚠️ Ложные пробои при боковике"),
